...
class Expiredads extends Component {
    ...
    render() {
        return (
            <View>
                <ScrollView>
                    <Text style={{ textAlign: "center", fontWeight: "bold", fontSize: 15, padding: 10, borderBottomWidth: 1, borderBottomColor: "lightgrey", borderTopWidth: 1, borderTopColor: "lightgrey" }}>Expired Ads</Text>
                    <View style={{ height: "100%", width: "100%", backgroundColor: "#F4F4F4", padding: 5 }}>
                        <TouchableOpacity>
                            <View style={{ marginTop: 10, padding: 10, width: "100%", backgroundColor: "white", flexDirection: "row", opacity: 0.5 }}>
