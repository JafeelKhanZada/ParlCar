  ...
  return (
    <View>
      ...
      <View style={{ height: hp("100%"), backgroundColor: "#F4F4F4", padding: 10 }} >
        {ProfileData && ProfileData.map((v, k) => {
          return (
              ...
              <View style={{ height: hp("55%"), backgroundColor: "white", marginTop: "30%", marginBottom: "30%", position: "relative" }}>
                <View style={{ justifyContent: "center", alignItems: "center" }}>
                  <View style={{ height: 150, width: 150, backgroundColor: "#F7F7F7", top: -90, borderRadius: 10, borderColor: "#ffff", borderWidth: 1, overflow: "hidden" }}>
                    <TouchableOpacity>
                      <Image style={{ height: 150, width: 150 }} source={{ uri: `http://207.180.230.73/palcar${v.Logo}` }} />
                    </TouchableOpacity>
                  </View>
                </View>
                <View style={{ justifyContent: "center", alignItems: "center", marginTop: -70 }}>
                  <Text style={{ fontSize: 13, fontFamily: "Poppins-Medium", color: "#db2025" }}>Welcome</Text>
                  <Text style={{ fontFamily: "Poppins-Bold" }}>{v.UserName}</Text>
                </View>
                <View style={{ height: hp("34%") }}>
                  <ScrollView style={{ width: "100%", flex: 1, padding: 10 }} showsVerticalScrollIndicator={false} >
                    <View style={{ width: "100%", flexDirection: "row", padding: 10 }}>
                      <View style={{ flexDirection: "row", width: "45%" }}>
                        <Image resizeMethod="resize" resizeMode="contain" source={Img1} style={{ height: 20, width: 20, paddingRight: 50 }} />
                        <Text style={{ color: "grey", fontFamily: "Poppins-Light" }}>Mobile</Text>
                      </View>
                      <Text style={{ fontFamily: "Poppins-Medium" }}>{v.ShowroomTelephone}</Text>
                    </View>
                    <View style={{ width: "100%", flexDirection: "row", padding: 10 }}>
                      <View style={{ flexDirection: "row", width: "45%" }}>
                        <Image resizeMethod="resize" resizeMode="contain" source={Img2} style={{ height: 20, width: 20, paddingRight: 50 }} />
                        <Text style={{ color: "grey", fontFamily: "Poppins-Light" }}>Email Adress</Text>
                      </View>
                      <Text style={{ fontFamily: "Poppins-Medium" }}>{v.Email}</Text>
                    </View>
                    <View style={{ width: "100%", flexDirection: "row", padding: 10 }}>
                      <View style={{ flexDirection: "row", width: "45%" }}>
                        <Image resizeMethod="resize" resizeMode="contain" source={Img3} style={{ height: 20, width: 20, paddingRight: 50 }} />
                        <Text style={{ color: "grey", fontFamily: "Poppins-Light" }}>City</Text>
                      </View>
                      <Text style={{ fontFamily: "Poppins-Medium" }}>{v.CityName}</Text>
                    </View>
                    <View style={{ width: "100%", flexDirection: "row", padding: 10 }}>
                      <View style={{ flexDirection: "row", width: "45%" }}>
                        <Image resizeMethod="resize" resizeMode="contain" source={Img4} style={{ height: 20, width: 20, paddingRight: 50 }} />
                        <Text style={{ color: "grey", fontFamily: "Poppins-Light" }}>Country</Text>
                      </View>
                      <Text style={{ fontFamily: "Poppins-Medium" }}>Pak</Text>
                    </View>
                    <View style={{ width: "100%", flexDirection: "row", padding: 10 }}>
                      <View style={{ flexDirection: "row", width: "45%" }}>
                        <Image resizeMethod="resize" resizeMode="contain" source={Img5} style={{ height: 20, width: 20, paddingRight: 50 }} />
                        <Text style={{ color: "grey", fontFamily: "Poppins-Light" }}>Password</Text>
                      </View>
                      <Text style={{ fontFamily: "Poppins-Medium" }}>********</Text>
                    </View>
                    <View style={{ width: "100%", flexDirection: "row", padding: 10 }}>
                      <View style={{ flexDirection: "row", width: "45%" }}>
                        <Image resizeMethod="resize" resizeMode="contain" source={Img6} style={{ height: 20, width: 20, paddingRight: 50 }} />
                        <Text style={{ color: "grey", fontFamily: "Poppins-Light" }}>No. of Ads</Text>
                      </View>
                      <Text style={{ fontFamily: "Poppins-Medium" }}>{TotalCount}</Text>
                    </View>
                  ...
                  <View style={{ paddingTop: 10 }}>
                    <TouchableOpacity style={{ alignSelf: "center", padding: 3, backgroundColor: "#db2025", width: "40%", justifyContent: "center", alignItems: "center" }}>
